...
<div class="app-hero-header d-flex align-items-start">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"> บันทึกข้อมูลวัคซีน </li>
    </ol>
                        ...
                        <div class="col-xxl-12">
                            <div class="card mb-3">
                                <div class="card-body">
                                        ...
                                        <img class="rounded-circle img-4x me-2"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group has-validation">
                                                        <select name="vaccine_id" id="vaccine_id" class="form-select" required>
                                                            ...
                                                            <?php
                                                            include "config.inc.php";
                                                            $sql_vaccine = " SELECT * FROM tbl_vaccine ORDER BY vaccine_id DESC ";
                                                            $query_vaccine = $conn->query($sql_vaccine);
                                                            while ($result_vaccine = $query_vaccine->fetch_assoc()) {
                                                            ?>
                                                                <option value="<?php echo $result_vaccine['vaccine_id'];?>"><?php echo $result_vaccine['vaccine_name'];?></option>
                                                            <?php  } $conn->close();  ?>
                                                            </select>
